    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body">
                ...
                <div class="col-sm-6">
                <label class="col-sm-6 control-label text-right formfonterp"
                       for="form-field-1"><strong> <?php echo get_phrase('Manufactur_No') ?>.</strong></label>
                    <div class="input-group">
                        <input type="text" name="order_no" value="" class="form-control" placeholder="Order No"
                               autocomplete="off"/>
                ...
                <div class="col-sm-6">
                    <div class="input-group">
                    <label class="col-sm-12 control-label text-right formfonterp"
                       for="form-field-1"><strong> <?php echo get_phrase('Reference_order_No') ?>.</strong></label>
                        <span class="input-group-addon" style="background-color:#fff;border:1px solid black">
                            <?php echo $voucherID; ?>
                    ...
                    <fieldset style="">
                        <legend style="">Raw Material :<input type="checkbox" value="InventoryOutAdd" name=""
                    ...
                    <fieldset style="">
                        <legend style=" " class="">Finish Goods : <input type="checkbox" value="InventoryReciptAdd"
...
<script type="text/javascript">
    ...
    function isconfirmSave() {
        ...
        if ($('#InventoryOutAdd').prop("checked") == true) {
         ...
         if (total_inventory_in_price == 0 && total_inventory_out_price == 0) {
