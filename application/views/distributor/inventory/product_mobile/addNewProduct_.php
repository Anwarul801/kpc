            ...
            <div class="portlet-body">
                ...
                <form id="publicForm" action=""  method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select  id="productCategory"  onchange="checkDuplicateProduct()" name="category_id"  class="chosen-select form-control" data-placeholder="Search product Category">
                                <option></option>
                    ...
                    <div class="form-group" style="<?php echo $ProductSubCategory=='dont_have_this_property'?'display: none':''?>">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php echo get_phrase($ProductSubCategory)?></label>
                        <div class="col-sm-6">
                            <select  id="subcategory"   name="subcategory"  class="chosen-select form-control" data-placeholder="Search subcategory">
                                <option></option>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php echo get_phrase('Brand')?><span style="color:red!important"> *</span></label>
                        <div class="col-sm-6">
                            <select  id="brandId"  onchange="checkDuplicateProduct()" name="brand"  class="chosen-select form-control"  data-placeholder="Search Brand">
                                <option></option>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php echo get_phrase('Model')?><span style="color:red!important"> *</span></label>
                        <div class="col-sm-6">
