                                    ...
                                    <table class="table table-hover table-bordered table-striped" id="ALLPRODUCT">
                                        ...
                                        foreach ($stockList[$purchasesList->purchase_invoice_id] as $key => $each_info):
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    $product_info = $this->Common_model->get_single_data_by_single_column('product', 'product_id', $each_info['product_id']);
                                                    if($product_info->category_id  ==4){

                                                        $model_info = $this->Common_model->get_single_data_by_single_column('tb_model', 'ModelID', $product_info->modelID);
                                                        $color_info = $this->Common_model->get_single_data_by_single_column('tb_color', 'ColorID', $product_info->colorID);
                                                        echo $model_info->Model . ' ' . $color_info->Color . " " . $each_info['productName'] . ' [ ' . $each_info['brandName'] . ' ] ';
                                                        echo "<br>";
                                                        echo '<i>'.$product_info->description."</i>";
                                                    }else{
                                                        echo $each_info['title'] . ' ' . $each_info['productName'] . ' ' . $each_info['unitTtile'] . ' [ ' . $each_info['brandName'] . ' ] ';
                                                    }

                                                    // $prodict_info = $this->common_model->get_single_data_by_single_column('product', 'product_id', $each_info['product_id']);
                                                    //echo $each_info['title'] . ' ' . $each_info['productName'] . ' ' . $each_info['unitTtile'] . ' [ ' . $each_info['brandName'] . ' ] ';
                                        ...
                                        <tfoot>
                                        <tr>
                                            <td colspan="<?php echo  $number_of_property+4?>" align="right">
                                                <strong><?php echo get_phrase('Sub_Total') ?></strong></td>
                                            <td align='right'><?php echo number_format((float)$tprice, 2, '.', ','); ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="<?php echo  $number_of_property+4?>" align="right"><strong><?php echo get_phrase('Discount') ?> (
                                                    - )</strong></td>
                                            <td align='right'><?php echo number_format((float)$purchasesList->discount_amount, 2, '.', ','); ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="<?php echo  $number_of_property+4?>" align="right"><strong><?php echo get_phrase('Loader') ?> ( +
                                                    )</strong></td>
                                        ...
                                        <tr>
                                            <td colspan="<?php echo  $number_of_property+6?>">
