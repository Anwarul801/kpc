            ...
            <div class="portlet-body">
                    ...
                    <table id="unitDatatable" class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th><?php echo get_phrase('Unit Name')?></th>

                            <th><?php echo get_phrase('Unit Code')?></th>
    ...
    $(document).ready(function () {
        ...
        var table = $('#unitDatatable').DataTable({
            ...
            "ajax": {
                ...
                "url": "<?php echo site_url('lpg/ServerFilterController/unitList') ?>",
...
<script>
    ...
    function deleteUnit(deleteId) {
        var url1='<?php echo site_url("lpg/UnitController/deleteUnit/")?>';
        swal({
