                        ...
                        <tr>
                            <td colspan="16">
                                ...
                                if ($condition == 'ERROR') {
                                    ...
                                    ?>
                                    <a
                                            href="<?php echo site_url('ImportController/saveImportEmplloyee'); ?>"
                                            id="showSaveBtn"
...
<script>
    ...
    function callEditModel(importid) {
        var main_url = '<?php echo site_url(); ?>' + 'InventoryController/updateEmployeeInfo';
        $.ajax({
            url: main_url,
            type: 'post',
            data: {
    ...
    function deleteEmployee(deleteId) {
        var url1 = '<?php echo site_url()?>lpg/ImportController/deleteImportEmployee/';
        swal({
                title: "Are you sure ?",
