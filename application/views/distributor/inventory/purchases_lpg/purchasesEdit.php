...
?>
<div class="row">
    <?php if($this->session->flashdata('error_in_stock')){?>
        <div class = "alert alert-danger alert-dismissable">
            <button type = "button" class = "close" data-dismiss = "alert" aria-hidden = "true">
            </button>
            <?php echo $this->session->flashdata('error_in_stock')?>
        </div>
    <?php }?>
    ...
    <form id="publicForm" action="" method="post" class="form-horizontal">
                        ...
                        foreach ($accountHeadList as $key => $head) {
                            ...
                            <optgroup
                                ...
                                foreach ($head['Accountledger'] as $eachLedger) :
                                    ?>
                                    <option <?php
                                    if ($eachLedger->id == $purchase_invoice_cash_ledger_id) {
                                        echo "selected";
                                    }
        ...
        <div class="col-sm-12 col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <div class="input-group">
                        <input type="text" id="form-field-1" name="userInvoiceId" value="<?php echo $purchasesList->supplier_invoice_no; ?>" class="form-control"
                               placeholder="Voucher ID "/>
                        <span class="input-group-addon" style="background-color:#fff">
                            <?php echo $purchasesList->invoice_no; ?>
                            <input type="hidden" id="" name="voucherid" readonly value="<?php echo $purchasesList->invoice_no; ?>"/>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" id="form-field-1" name="reference" value=" <?php echo $purchasesList->refference_person; ?>"
                ...
                <div class="col-sm-7">
                    <select name="loader" class="chosen-select form-control"
                        ...
                        <?php foreach ($employeeList as $key => $eachEmp): ?>
                            <option
                                <?php
                                if ($purchasesList->loader_emp_id ==  $eachEmp->id) {
                                    echo "selected";
                                }
                                ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <select name="branch_id" class="chosen-select form-control"
                        ...
                        echo branch_dropdown(null,$purchasesList->branch_id );
                        ?>
                    </select>
                </div>
            </div>
        ...
        <div class="col-md-10" style="margin-top:10px">
            ...
            <table class="table table-bordered table-hover" id="show_item">
                ...
                $totalEditPrice = 0;
                $slNo=100;
                foreach ($stockList[$purchasesList->purchase_invoice_id] as $key => $eachStock ){
                    ...
                    <tr class="new_item<?php echo $key + 100; ?>">
                        <td style="padding-left:15px;" colspan="2">
                            ...
                            <input type="hidden" name="package_id_<?php echo  $slNo; ?>" value="0"/>
                            <input type="hidden" name="purchase_details_id_<?php echo  $slNo; ?>" value="<?php echo $eachStock['purchase_details_id']; ?>"/>
                            <input type="hidden" name="category_id[]" value="<?php echo $eachStock['category_id']; ?>"/>
                            <input type="hidden" name="is_package_<?php echo  $slNo; ?>" value="<?php echo $eachStock['is_package']; ?>"/>
                            <?php

                            echo ' [ ' . $eachStock['title'] . ' ] ' . $eachStock['productName'] . ' [ ' . $eachStock['brandName'] . ' ] ';
                            ?>
                            <input type="hidden" name="product_id_<?php echo  $slNo; ?>" value="<?php echo $eachStock['product_id']; ?>">
                        </td>
                        <td align="right">
                            <input type="text" id="qty_<?php echo $key + 100; ?>" autocomplete="off" class="add_quantity text-right form-control decimal" name="quantity_<?php echo  $slNo; ?>" value="<?php echo $eachStock['quantity']; ?>">
                        </td>
                        
                        <td align="right">
                            <input type="text" id="rate_<?php echo $key + 100; ?>" autocomplete="off" class="add_rate  text-right form-control decimal" name="rate_<?php echo  $slNo; ?>" value="<?php echo $eachStock['unit_price']; ?>">
                        </td>
                        <td align="right">
                            <?php
                        ...
                        <input  type="text" class="add_property_1 text-right form-control" id="property_1_<?php echo $slNo ?>" name="property_1_<?php echo $slNo ?>" value="<?php echo  $eachStock['property_1']; ?>">
                        </th>
                        <th nowrap  style="text-align: center;width:10%;border-radius:10px;<?php echo $property_2=='dont_have_this_property'?'display: none':''?> ">
                            <input  type="text" class="add_property_2 text-right form-control" id="property_2_<?php echo $slNo ?>" name="property_2_<?php echo $slNo ?>" value="<?php echo  $eachStock['property_2']; ?>">

                        </th>
                        <th nowrap  style="text-align: center;width:10%;border-radius:10px; <?php echo $property_3=='dont_have_this_property'?'display: none':''?>">
                        <input  type="text" class="add_property_3 text-right form-control" id="property_3_<?php echo $slNo ?>" name="property_3_<?php echo $slNo ?>" value="<?php echo  $eachStock['property_3']; ?>">
                        </th>
                        <th nowrap  style="text-align: center;width:10%;border-radius:10px; <?php echo $property_4=='dont_have_this_property'?'display: none':''?>">
                        <input  type="text" class="add_property_4 text-right form-control" id="property_4_<?php echo $slNo ?>" name="property_4_<?php echo $slNo ?>" value="<?php echo  $eachStock['property_4']; ?>">
                        </th>
                        <th nowrap  style="text-align: center;width:10%;border-radius:10px;<?php echo $property_5=='dont_have_this_property'?'display: none':''?>">
                        <input  type="text" class="add_property_5 text-right form-control" id="property_5_<?php echo $slNo ?>" name="property_5_<?php echo $slNo ?>" value="<?php echo  $eachStock['property_5']; ?>">
                        </th>
                        <td>
                ...
                <tr>
                    <td>
                                                            <textarea style="border:none;" cols="120"
                                                                      ...
                                                                      type="text"><?php echo $purchasesList->narration?></textarea>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="clearfix form-actions">
            <div class="col-md-offset-3 col-md-9">
                <button onclick="return isconfirm2()" id="subBtn" class="btn btn-info" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Processing "
                        type="button">
