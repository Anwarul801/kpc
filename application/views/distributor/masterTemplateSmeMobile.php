    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                $priviousDateEnrtyBlockPurchase = in_array($priviousDateEnrtyBlockPurchase, $PermitionList) ? $priviousDateEnrtyBlockPurchase : 0;

                echo '<input type="hidden" id="priviousDateEnrtyBlockSalesID" value="' . $priviousDateEnrtyBlockSalesID . '">';
                echo '<input type="hidden" id="priviousDateEnrtyBlockPurchaseID" value="' . $priviousDateEnrtyBlockPurchase . '">';
