                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                                    ...
                                    <table id="example" class="table-bordered  "  >
                                        <caption><label><strong>Voucher:</strong><span><?php echo $getAllsalaryByDateListView[0]->voucherNo; ?></span></label>&nbsp<label><strong>Date:</strong><span><?php echo $getAllsalaryByDateListView[0]->date; ?></span></label>&nbsp <label><strong>Month:</strong><span><?php echo $getAllsalaryByDateListView[0]->month; ?></span>
