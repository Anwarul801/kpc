        ...
        <div class="portlet box blue">
            ...
            <table border="1" class="table table-bordered datatable" id="table-1">
                <tr>
                    ...
                    <tr>
                        <th><center style="text-align: center;">Over Time Field Permisson</center>
                           <center style="text-align: center;"><input type="checkbox" id="checkAll">All Check 
                ...
                <div class="col-md-6">
                        ...
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Field </th>
                                <th>Percentance Of Basic Salary</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            foreach ($Employeevoucher as $key => $value){ 
                                ?>
                                <tr>
                                    <td><?php echo $key + 1; ?></td> 

                                    <td><?php echo $value->fieldName; ?></td>
                                    <td><?php echo $value->percentance; ?></td>
                                                                        <td>
                                        <div class="hidden-sm hidden-xs action-buttons">

                                            <a class="btn btn-icon-only red" href="<?php echo site_url($this->project.'/overTimeConfigEdit/' . $value->id ); ?>">
            ...
            <div class="modal-body">
                ...
                <script type="text/javascript">
                    ...
                    function saveconfigaration(type, id) {
                        ...
                        var url = baseUrl + "lpg/employeeSalaryConfigureController/saveBankBookConfig";
                        $.ajax({
                            type: 'POST',
                            url: url,
                            data: userData,
                    ...
                    function getconfig() {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: baseUrl + "lpg/employeeSalaryConfigureController/getconfig",
