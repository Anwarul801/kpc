...
tfoot input {
    ...
    table.dataTable thead th,table.dataTable tfoot th{font-weight:bold}table.dataTable thead th,table.dataTable thead td{
                            ...
                            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                                <div class="portlet green-meadow box" style="border: 1px solid #3598dc;">
                                    <div class="portlet-title" style="background-color: #3598dc;">
                                        <div class="caption">
                                            <?php echo get_phrase('Over Time Payment Details') ?>  </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                                    ...
                                    <table id="example" class="table-bordered"  >
                                        <caption><label><strong>Date:</strong><span><?php echo $getAllsalaryByDateListView[0]->date; ?></span></label>&nbsp <label><strong>Month:</strong><span><?php echo $getAllsalaryByDateListView[0]->month; ?></span>
                                            ...
                                            &nbsp<label><strong>Voucher No:</strong><span><?php echo $getAllsalaryByDateListView[0]->voucherNo; ?></span></label>
                                        </caption>
                            ...
                            <tr>
                                ...
                                <th><?php echo $value->fieldName; ?> </th>
                                 ...
                                 <th > Signature</th>
                                        ...
                                        $graunatTotal = 0;
                                            ...
                                            $graunatTotalOverTimeHour += $value->overTimeHour;
                                            $graunatTotalOverTimeRate += $value->overTimeRate;
                                ...
                                if($row->id =='17') { ?>
                                                ...
                                                <?php }  
                                if($row->id =='18') { ?>
                                                <td align="right"><?php echo $value->overTimeHour; ?></td>
                                                <?php }  
                                if($row->id =='19') { ?>
                                                <td align="right"><?php echo $value->overTimeRate; ?></td>
                                                 <?php }  
                                if($row->id =='20') { ?>
                                ...
                                if($row->id =='18') { ?>
                                                ...
                                                <?php }  
                                if($row->id =='19') { ?>
                                                <td align="right"><?php  echo number_format($graunatTotalOverTimeHour, 2);?></td>
                                                <?php }  
                                if($row->id =='20') { ?>
                                                <td align="right"><?php  echo number_format($graunatTotalOverTimeRate, 2);?></td>
                                                <?php }  
                                if($row->id =='21') { ?>
   ...
   $(document).ready(function () {
    ...
    $tableList = $tableEle.DataTable({
            ...
            api.column(groupCol, {
                ...
                if (last !== group) {
                    groupID++;
                    $(rows).eq(i).before("<tr  class='groupTR'><td>sub Total</td><td colspan='4' class='groupTitle'>" + group + "</td></tr>");
                    last = group;
                }
