                        ...
                        <tbody>
                                ...
                                if($row->id =='17') { ?>
                                    <td style="width: 5%"><input type="text" id="arrearSalary_<?php echo $value->id; ?>" attr-id="<?php echo $value->id; ?>" name="arrearSalary[]" value="<?php if($row->percentance =='0'){
                                        ...
                                        <?php } 
                                if($row->id =='18') { ?>
                                    <td style="width: 5%"><input type="text" id="overTimeHour_<?php echo $value->id; ?>" attr-id="<?php echo $value->id; ?>" name="overTimeHour[]" value="<?php if($row->percentance =='0'){
                                            echo $row->percentance;
                                        } else{ echo $row->percentance; }?>" class="form-control overTimeHour"placeholder="" style="text-align: right;"/></td>
                                        <?php } 
                                if($row->id =='19') { ?>
                                    <td style="width: 5%"><input type="text" id="overTimeRate_<?php echo $value->id; ?>" attr-id="<?php echo $value->id; ?>" name="overTimeRate[]" value="<?php if($row->percentance =='0'){
                                            echo $rate;
                                        } else{ echo $rate * $row->percentance; }?>" class="form-control overTimeRate"placeholder="" style="text-align: right;"/></td>
                                ...
                                if($row->fieldName =='Net Pay Amount') { ?>
                                    <td style="width: 8%"><input type="text" id="netPayAmount_<?php echo $value->id; ?>" attr-id="<?php echo $value->id; ?>" name="netPayAmount[]" value="<?php if($percentanceSum[0]->perf =='0' && $percentanceSubt[0]->perf2 =='0'){
                                            echo $rate*($overtimeHour['0']->overTimeHour*1 * $overtimeRate['0']->overTimeRate*1);
                                        } else{ echo $value->salary*(($percentanceSum[0]->perf)/100 -($percentanceSubt[0]->perf2)/100)+$rate($overtimeHour['0']->overTimeHour*1 * $overtimeRate['0']->overTimeRate*1); } ?>" class="form-control netPayAmount"placeholder=""
