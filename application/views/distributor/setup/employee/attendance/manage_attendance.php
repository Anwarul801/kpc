                    ...
                    <div class="panel panel-default" data-collapsed="0">                    
                        <div class="panel-heading">
                            <div class="panel-title">
                                <strong>Attendace</strong>
                            </div>
                        </div>
                        <div class="panel-body">
                            <form id="form" action="<?php echo site_url('hr/attendanceController/manage_attendance'); ?>" method="post"  enctype="multipart/form-data" class="form-horizontal">   
                                    ...
                                    <div class="form-group margin">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control date-picker" name="date"  id="dateOfBirth" type="text" value="<?php echo date('d-m-Y'); ?>" data-date-format="dd-mm-yyyy" required/>
                                        ...
                                        <div class="col-sm-5">
                                            <select name="department_id" id="department" class="form-control">
                                                ...
                                                <?php foreach ($all_department as $v_department) : ?>
                                                    <option value="<?php echo $v_department->DepartmentID ?>"                                                     
                                                    <?php
                                                    if (!empty($DepartmentID)) {
                                                        echo $v_department->DepartmentID == $DepartmentID ? 'selected' : '';
                                                    }
                                                    ?>                                                    
                                                            >
                                                        <?php echo $v_department->DepartmentName ?></option>
                                                <?php endforeach; ?>
