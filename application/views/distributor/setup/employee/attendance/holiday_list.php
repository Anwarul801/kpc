...
<div class="row margin">  
    ...
    <?php endif;?>
    <div class="col-sm-9">
        <h4 class="pull-left holiday-vertical"> <?php echo anchor($this->project . '/holiday_list/1', '<i class="fa fa-plus"></i> Add Holiday'); ?></h4>        
    </div>
</div>
<?php if (!empty($active_add_holiday)): ?>
    <div class="row">
            ...
            <div class="wrap-fpanel">
                <div class="panel panel-default" data-collapsed="0">
                    ...
                    <div class="panel-body">                                
                        <form id="form" action="<?php echo site_url($this->project.'/save_holiday'); ?>" method="post" class="form-horizontal form-groups-bordered">                       
                                    ...
                                    <tbody>
                                        ...
                                        <?php if (!empty($v_holiday_list)): foreach ($v_holiday_list as $v_holiday) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                       <a class="btn btn-icon-only red" href="<?php echo site_url($this->project.'/delete_holiday_list/' . $v_holiday->holiday_id ); ?>">
