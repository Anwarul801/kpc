...
<div class="row">
    ...
    <form id="po_form" action="" method="post" class="form-horizontal">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label no-padding-right" for="po_id">
                            <?php echo get_settings('purchase_order_id') ?>  <span style="color:red;"> &nbsp &nbsp</span>
                        </label>

                        <div class="col-sm-7">
                            <input type="text" id="po_id" name="po_id" readonly required
                                   value="<?php echo get_so_po_no('PO');; ?>"
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label no-padding-right" for="purchase_order_date">
                            <?php echo get_settings('purchase_order_date') ?>   <span style="color:red;"> &nbsp*</span>
                        </label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label no-padding-right" for="po_delivery_date">
                            <?php echo get_settings('purchase_order_delivery_date') ?>  <span style="color:red;"> &nbsp*</span>
                        </label>
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control date-picker-sales" name="po_delivery_date" required
                                       id="po_delivery_date"
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Reference <span style="color:red;"> &nbsp&nbsp</span></label>

                        <div class="col-sm-7">

                            <select name="reference" class="chosen-select form-control" id="form-field-select-3"
                                    data-placeholder="Search Reference ID or Name">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            ...
                            <select name="branch_id" class="chosen-select form-control"
                                    id="BranchAutoId" data-placeholder="Select Branch" required>
                                <option value=""></option>
                                <?php
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6" style="<?php echo get_settings_status('purchase_order_extra_field_1') == 1 ? "" : "display: none" ?>">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                            <?php echo get_settings('purchase_order_extra_field_1') ?> <span style="color:red;"> &nbsp&nbsp</span>
                        </label>

                        <div class="col-sm-7">

                            <input class="form-control " name="purchase_order_extra_field_1" id="purchase_order_extra_field_1" type="text" value="" autocomplete="off" placeholder="<?php echo get_settings('purchase_order_extra_field_1') ?>"/>
                ...
                <div class="col-md-6" style="<?php echo get_settings_status('purchase_order_extra_field_2') == 1 ? "" : "display: none" ?>">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input class="form-control " name="purchase_order_extra_field_2" id="purchase_order_extra_field_2" type="text" value="" autocomplete="off" placeholder="<?php echo get_settings('purchase_order_extra_field_2') ?>"/>
                ...
                <div class="col-md-6" style="<?php echo get_settings_status('purchase_order_extra_field_3') == 1 ? "" : "display: none" ?>">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input class="form-control " name="purchase_order_extra_field_3" id="purchase_order_extra_field_3" type="text" value="" autocomplete="off" placeholder="<?php echo get_settings('purchase_order_extra_field_3') ?>"/>
                ...
                <div class="col-md-6" style="<?php echo get_settings_status('purchase_order_extra_field_4') == 1 ? "" : "display: none" ?>">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input class="form-control " name="purchase_order_extra_field_4" id="purchase_order_extra_field_4" type="text" value="" autocomplete="off" placeholder="<?php echo get_settings('purchase_order_extra_field_4') ?>"/>
                ...
                <div class="col-md-6" style="<?php echo get_settings_status('purchase_order_extra_field_5') == 1 ? "" : "display: none" ?>">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input class="form-control " name="purchase_order_extra_field_5" id="purchase_order_extra_field_5" type="text" value="" autocomplete="off" placeholder="<?php echo get_settings('purchase_order_extra_field_5') ?>"/>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6" style="<?php echo get_settings_status('purchase_order_lc_field_1') == 1 ? "" : "display: none" ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            ...
                            <input class="form-control " name="purchase_order_lc_field_1" id="purchase_order_lc_field_1" type="text" value="" autocomplete="off" placeholder="<?php echo get_settings('purchase_order_lc_field_1') ?>"/>
                ...
                <div class="col-md-6" style="<?php echo get_settings_status('purchase_order_lc_field_2') == 1 ? "" : "display: none" ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            ...
                            <input class="form-control " name="purchase_order_lc_field_2" id="purchase_order_lc_field_2" type="text" value="" autocomplete="off" placeholder="<?php echo get_settings('purchase_order_lc_field_2') ?>"/>
                ...
                <div class="col-md-6" style="<?php echo get_settings_status('purchase_order_lc_field_3') == 1 ? "" : "display: none" ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            ...
                            <input class="form-control " name="purchase_order_lc_field_3" id="purchase_order_lc_field_3" type="text" value="" autocomplete="off" placeholder="<?php echo get_settings('purchase_order_lc_field_3') ?>"/>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"><?php echo get_settings('purchase_order_shipping_address') ?><span style="color:red;"> &nbsp&nbsp</span></label>
            ...
            <div class="col-md-12 ">
                ...
                <table class="table table-bordered table-hover tableAddItem" id="show_item">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" onclick="this.select();" class="form-control text-right rate decimal"
                                   placeholder="0.00">
                        </td>
                        <td>
...
<script>
    ...
    function isconfirm2() {
        ...
        var po_delivery_date = $("#po_delivery_date" +
            "").val();
