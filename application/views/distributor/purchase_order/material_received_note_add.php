        ...
        <div class="col-md-12">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Supplier ID <span
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <label class="col-sm-3 control-label no-padding-right"
                           for="form-field-1"><?php echo get_phrase("material received note no") ?> <span
                                style="color:red;"> &nbsp*</span></label>

                    <div class="col-sm-7">

                        <input class="form-control " name="sdc_mrn_no" id="" type="text"
                               value="<?php echo create_mrn_sdc_no() ?>"
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-4 control-label no-padding-right" for="so_id"> Purchase Order ID <span
                                style="color:red;"> &nbsp*</span></label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Recived Date <span
                                style="color:red;"> &nbsp*</span></label>
            ...
            <div class="col-md-12 ">
                ...
                <table class="table table-bordered table-hover tableAddItem" id="show_item">
                    ...
                    <tr>
                        ...
                        <th style="white-space:nowrap;  vertical-align:top;">
                            ...
                            <strong><?php echo get_phrase('PO quantity') ?> <span
                                        style="color:red;"> *</span></strong></th>

                        </th>
                        <th style="white-space:nowrap;  vertical-align:top;">
                        <strong>   <?php echo get_settings('unit_custom_field_2'). get_phrase('Quantity') ?>
                        </strong></th>
                        <th style="white-space:nowrap; vertical-align:top;">

                            <strong><?php echo get_phrase('received quantity') ?> <span
                                        style="color:red;"> *</span></strong></th>
                ...
                <table class="table table-bordered table-hover " >
                    ...
                    <td width="500px"></td>
                        ...
                        <td align="right"><strong id=""><input type="text" name="total_price" id="total_price" readonly
                                                               style="
    border: 0px;
    text-align: right;
"> </strong></td>
