        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase"> <?php echo get_phrase('material_received_note') ?>
                                    ...
                                    <div class="portlet-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4 invoice-payment">
                                                <h3><?php echo get_phrase('MRN Details') ?></h3>
                                                <ul class="list-unstyled">
                                                    <li>

                                                        <?php echo get_phrase('mrn_recived_date') ?>:
                                                        <?php
                                                        echo date('d-m-Y', strtotime($sdc_mrn_info->mrn_recived_date));
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><?php echo get_phrase('PO')?></td>
                                        ...
                                        <tfoot>
                                        <tr>
                                            <td colspan="<?php echo  $number_of_property+8?>" align="right">
