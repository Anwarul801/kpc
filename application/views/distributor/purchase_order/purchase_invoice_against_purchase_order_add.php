 ...
 */
?>
<link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-tour/0.12.0/css/bootstrap-tour-standalone.min.css"
      rel="stylesheet" type="text/css"/>
<link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-tour/0.12.0/css/bootstrap-tour.min.css"
      rel="stylesheet" type="text/css"/>
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-tour/0.12.0/js/bootstrap-tour-standalone.js"
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-4 control-label no-padding-right" for="so_id"> Purchases Order ID</label>

                    <div class="col-sm-6" id="soIdDiv">
                        <select id="soId" name="so_id" onchange="getSodetails(this.value)"
                                class="chosen-select form-control"
                                data-placeholder="Select  Purchases Order ">
                            <option value=""></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <textarea placeholder="Shipping Address" class=" form-control" id="shippingAddress"
                                  name="shippingAddress" cols="47" readonly
                                  rows="1"></textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="userInvoiceId" value="" class="form-control"
...
// Start the tour
    ...
    function getCustomerdetails_and_so_detaisl(supplier_id) {

        $("#getSodetails").closest('form').find("input[type=text], textarea").val("");
        ...
        if (supplier_id != "") {
            ...
            var url = baseUrl + "lpg/PurchaseOrderController/getSupplierCurrentBalance";
            $.ajax({
                type: 'POST',
                url: url,
                data: {
...
//                    }
    ...
    function load_so_ides() {
        ...
        if (supplier_id == "") {
            ...
            $.ajax({
                type: "POST",
                url: baseUrl + "lpg/PurchaseOrderController/getCustomerdetails_and_so_details",
    ...
    function getSodetails(so_id) {
        ...
        if (so_id != "") {
            ...
            var url = baseUrl + "lpg/PurchaseOrderController/getSoInfo";
            $.ajax({
                type: 'POST',
                url: url,
                data: {
    ...
    function load_so_product(so_id) {
        ...
        if (so_id != "") {
            var table = $('#show_item').DataTable({
                ...
                "ajax": {
                    url: "<?php echo site_url('lpg/PurchaseOrderController/get_so_po_products'); ?>",
                    "type": "POST",
                    "data": function (data) {
