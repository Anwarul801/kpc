            ...
            <table class="table table-bordered table-hover tableAddItem" id="show_item">
                ...
                foreach ($editStock[$editInvoice->sales_invoice_id] as $key => $each_info):
                    ...
                    <tr class="new_item<?php echo $j ?>">
                        ...
                        <input  type="text" class="add_property_1 text-right form-control" id="property_1_<?php echo $j ?>" name="property_1_<?php echo $slNo ?>" value="<?php echo  $each_info['property_1']; ?>">
                                                </th>
                                                <th nowrap  style="text-align: center;width:10%;border-radius:10px;<?php echo $property_2=='dont_have_this_property'?'display: none':''?> ">
                                                    <input  type="text" class="add_property_2 text-right form-control" id="property_2_<?php echo $j ?>" name="property_2_<?php echo $slNo ?>" value="<?php echo  $each_info['property_2']; ?>">

                                                </th>
                                                <th nowrap  style="text-align: center;width:10%;border-radius:10px; <?php echo $property_3=='dont_have_this_property'?'display: none':''?>">
                                                <input  type="text" class="add_property_3 text-right form-control" id="property_3_<?php echo $j ?>" name="property_3_<?php echo $slNo ?>" value="<?php echo  $each_info['property_3']; ?>">
                                                </th>
                                                <th nowrap  style="text-align: center;width:10%;border-radius:10px; <?php echo $property_4=='dont_have_this_property'?'display: none':''?>">
                                                <input  type="text" class="add_property_4 text-right form-control" id="property_4_<?php echo $j ?>" name="property_4_<?php echo $slNo ?>" value="<?php echo  $each_info['property_4']; ?>">
                                                </th>
                                                <th nowrap  style="text-align: center;width:10%;border-radius:10px;<?php echo $property_5=='dont_have_this_property'?'display: none':''?>">
                                                <input  type="text" class="add_property_5 text-right form-control" id="property_5_<?php echo $j ?>" name="property_5_<?php echo $slNo ?>" value="<?php echo  $each_info['property_5']; ?>">
                                                </th>
