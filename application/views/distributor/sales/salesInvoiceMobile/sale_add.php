...
-->
        ...
        <div class="col-md-10" style="margin-top: 10px;">
            ...
            <div class="col-sm-6">
                ...
                <div class="col-sm-7">
                    <input class="form-control" placeholder="Guarantor Name" name="guarantorName"
                           autocomplete="off"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label formfonterp" for="form-field-1"
                       style="white-space: nowrap;"><strong><?php echo get_phrase('Guarantor Details') ?></strong></label>
                <div class="col-sm-7">
                   <textarea style="height: 106px!important;" cols="150"
                  class="form-control" name="guarantorAddress"
                  placeholder="Guarantor Details......"
                  type="text"></textarea>
                </div>
            </div>
