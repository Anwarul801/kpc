                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered table-striped">
                                        ...
                                        <tr>
                                            <td colspan="8">
                                                <strong><span><?php echo get_phrase('guarantor Name') ?>
                                                        : &nbsp;</span> <?php echo $saleslist->guarantorName; ?>                                                </strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="8">
                                                <strong><span><?php echo get_phrase('guarantor Address') ?>
                                                        : &nbsp;</span> <?php echo $saleslist->guarantorAddress; ?>
