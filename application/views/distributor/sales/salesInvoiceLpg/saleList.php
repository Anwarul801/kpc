            ...
            <div class="portlet-body">
                ...
                <table id="salesDatatable" class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th><?php echo get_phrase('Sv_No') ?></th>
                        <!--<th>Type</th>-->
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#salesDatatable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('lpg/ServerFilterController/salesListLpg'); ?>",
                "type": "POST",
                "data": function (data) {
        ...
        swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    ...
                    var main_url = baseUrl + "lpg/SalesInvoiceEditController/sales_delete";
                    $.ajax({
                        url: main_url,
                        type: 'post',
                        data: {
