    ...
    <form id="publicForm" action="" method="post" class="form-horizontal" name="publicForm">
        ...
        <div class="col-md-10" style="margin-top: 10px;">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                <label class="col-sm-4 control-label formfonterp" for="form-field-1"
                       style="white-space: nowrap;"><strong><?php echo get_phrase('Guarantor Name') ?></strong></label>
                <div class="col-sm-7">
                    <input class="form-control" value="<?php echo  $editInvoice->guarantorName?>" placeholder="Guarantor Name" name="guarantorName"
                           autocomplete="off"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label formfonterp" for="form-field-1"
                       style="white-space: nowrap;"><strong><?php echo get_phrase('Guarantor Address') ?></strong></label>
                <div class="col-sm-7">
                   <textarea style="height: 106px!important;" cols="150"
                  class="form-control" name="guarantorAddress"
                  placeholder="Guarantor Address......"
                  type="text"><?php echo  $editInvoice->guarantorAddress?></textarea>
                </div>
            </div>
