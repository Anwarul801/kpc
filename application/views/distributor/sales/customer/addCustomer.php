        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body">
                <form id="publicForm" action="" method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right"
                               for="form-field-1"> <?php echo get_phrase('Customer Name') ?> <span
                                    style="color:red;"> *</span></label>
                        <div class="col-sm-6">
                            <input type="text" id="form-field-1" name="customerName" class="form-control required"
                                   placeholder="Customer Name" onblur="checkDuplicateCustomer(this.value)" required/>
...
<script>
    function checkDuplicatePhone(phone) {
        var url = '<?php echo site_url("lpg/CustomerController/checkDuplicatePhone") ?>';
