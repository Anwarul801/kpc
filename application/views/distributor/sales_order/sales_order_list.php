            ...
            <div class="portlet-body">
                ...
                <table id="salesDatatable" class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th><?php echo get_phrase('SO_ID') ?></th>
                        <!--<th>Type</th>-->
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#salesDatatable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('lpg/ServerFilterController/so_po_list'); ?>",
                "type": "POST",
                "data": function (data) {
    ...
    function delete_so_po(voucherType, id) {
            ...
            function (isConfirm) {
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        type: 'post',
                        data: {
                            'redirect_page': 'sales_order_list',
