            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        ...
                        <input type="text" id="so_id" name="so_id" readonly value="<?php echo $so_po_info->so_po_no; ?>"
                    ...
                    <div class="col-sm-6">
                        ...
                        <select name="reference" class="chosen-select form-control" id="form-field-select-3"
                            ...
                            <?php foreach ($referenceList as $key => $each_ref): ?>
                                ...
                                <option
                                    <?php
                                    if ($so_po_info->refference_person_id == $each_ref->reference_id) {
                                        echo "selected";
                                    }
