    ...
    <form id="publicForm" action="" method="post" class="form-horizontal">
        ...
        <div class="col-md-12">
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                            <?php echo get_settings('sales_order_customer_id') ?>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label no-padding-right" for="so_id">
                            <?php echo get_settings('sales_order_id') ?> <span style="color:red;"> &nbsp &nbsp</span>
                        </label>

                        <div class="col-sm-7">

                            <input type="text" id="so_id" name="so_id" readonly
                                   value="<?php echo get_so_po_no('SO');; ?>"
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label no-padding-right" for="so_date">
                            <?php echo get_settings('sales_order_date') ?> <span style="color:red;"> &nbsp*</span>
                        </label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label no-padding-right" for="so_delivery_date">
                            <?php echo get_settings('sales_order_delivery_date') ?> <span
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control date-picker-sales" name="so_delivery_date"
                                       id="so_delivery_date"
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Reference <span
                                    style="color:red;"> &nbsp&nbsp</span></label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Branch <span
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6"
                     style="<?php echo get_settings_status('sales_order_extra_field_1') == 1 ? "" : "display: none" ?>">

                    <div class="form-group">

                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                            <?php echo get_settings('sales_order_extra_field_1') ?> <span
                                    style="color:red;"> &nbsp&nbsp</span>
                        </label>

                        <div class="col-sm-7">

                            <input class="form-control " name="sales_order_extra_field_1" id="sales_order_extra_field_1"
                                   type="text" value="" autocomplete="off"
                                   placeholder="<?php echo get_settings('sales_order_extra_field_1') ?>"/>
                ...
                <div class="col-md-6"
                     style="<?php echo get_settings_status('sales_order_extra_field_2') == 1 ? "" : "display: none" ?>">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                            <?php echo get_settings('sales_order_extra_field_2') ?> <span
                                    style="color:red;"> &nbsp&nbsp</span>
                        </label>
                        <div class="col-sm-7">
                            <input class="form-control " name="sales_order_extra_field_2" id="sales_order_extra_field_2"
                                   type="text" value="" autocomplete="off"
                                   placeholder="<?php echo get_settings('sales_order_extra_field_2') ?>"/>
                ...
                <div class="col-md-6"
                     style="<?php echo get_settings_status('sales_order_extra_field_3') == 1 ? "" : "display: none" ?>">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                            <?php echo get_settings('sales_order_extra_field_3') ?> <span
                                    style="color:red;"> &nbsp&nbsp</span>
                        </label>
                        <div class="col-sm-7">
                            <input class="form-control " name="sales_order_extra_field_3" id="sales_order_extra_field_3"
                                   type="text" value="" autocomplete="off"
                                   placeholder="<?php echo get_settings('sales_order_extra_field_3') ?>"/>
                ...
                <div class="col-md-6"
                     style="<?php echo get_settings_status('sales_order_extra_field_4') == 1 ? "" : "display: none" ?>">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                            <?php echo get_settings('sales_order_extra_field_4') ?> <span
                                    style="color:red;"> &nbsp&nbsp</span>
                        </label>
                        <div class="col-sm-7">
                            <input class="form-control " name="sales_order_extra_field_4" id="sales_order_extra_field_4"
                                   type="text" value="" autocomplete="off"
                                   placeholder="<?php echo get_settings('sales_order_extra_field_4') ?>"/>
                ...
                <div class="col-md-6"
                     style="<?php echo get_settings_status('sales_order_extra_field_5') == 1 ? "" : "display: none" ?>">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                            <?php echo get_settings('sales_order_extra_field_5') ?> <span
                                    style="color:red;"> &nbsp&nbsp</span>
                        </label>
                        <div class="col-sm-7">
                            <input class="form-control " name="sales_order_extra_field_5" id="sales_order_extra_field_5"
                                   type="text" value="" autocomplete="off"
                                   placeholder="<?php echo get_settings('sales_order_extra_field_5') ?>"/>
            ...
            <div class="col-md-12">
                <div class="col-md-6"
                     style="<?php echo get_settings_status('sales_order_lc_field_1') == 1 ? "" : "display: none" ?>">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                            <?php echo get_settings('sales_order_lc_field_1') ?><span
                                    style="color:red;"> &nbsp&nbsp</span>
                        </label>
                        <div class="col-sm-7">
                            <input class="form-control " name="sales_order_lc_field_1" id="sales_order_lc_field_1"
                                   type="text" value="" autocomplete="off"
                                   placeholder="<?php echo get_settings('sales_order_lc_field_1') ?>"/>
                        </div>
                    </div>
                </div>
                <div class="col-md-6"
                     style="<?php echo get_settings_status('sales_order_lc_field_2') == 1 ? "" : "display: none" ?>">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                            <?php echo get_settings('sales_order_lc_field_2') ?><span
                                    style="color:red;"> &nbsp&nbsp</span>
                        </label>
                        <div class="col-sm-7">
                            <input class="form-control " name="sales_order_lc_field_2" id="sales_order_lc_field_2"
                                   type="text" value="" autocomplete="off"/>
                ...
                <div class="col-md-6"
                     style="<?php echo get_settings_status('sales_order_lc_field_3') == 1 ? "" : "display: none" ?>">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                            <?php echo get_settings('sales_order_lc_field_3') ?><span
                                    style="color:red;"> &nbsp&nbsp</span>
                        </label>
                        <div class="col-sm-7">
                            <input class="form-control " name="sales_order_lc_field_3" id="sales_order_lc_field_3"
                                   type="text" value="" autocomplete="off"/>
            ...
            <div class="col-md-12">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <label class="col-sm-2 control-label " for="form-field-1">Shipping
                            Address</label>
            ...
            <div class="col-md-12 ">
                ...
                <table class="table table-bordered table-hover tableAddItem" id="show_item">
                    ...
                    <tr>
                        ...
                        <th style="white-space:nowrap; width:100px; vertical-align:top;">
                            <strong>
                                <?php echo get_phrase('Quantity') . "  (" . get_settings('unit_custom_field_1') . ")" ?>
                                <span
                                        style="color:red;"> *</span>
                            </strong>
                        </th>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="hidden" class="form-control text-right is_same decimal" value="0"><input
                                    type="hidden" value="" id="stockQty"/>
                            <input type="text" onclick="this.select();" onkeyup="unitConvertion(this.value,0,0);"
                        ...
                        <td>
                            <input type="text" onclick="this.select();"
                                   class="form-control text-right one_line_narration"
                                   placeholder="">
                        </td>
                        <td>
                    ...
                    <tfoot>
                    <tr>
                        <td align="right" colspan="<?php echo 2 ?>">
                            <strong>Total </strong>
                        </td>
                        <td align="right">
...
<script>
    ...
    function addRowProduct(productID, productName, productCatID, productCatName, productBrandID, productBrandName, productUnit, unitName, property_1, property_2, property_3, property_4, property_5, quantity=1, given_rate="", one_line_narration="", unit_custom_field_1, box_quantity) {// quantity,returnQuantity, rate, price
        ...
        var unit_custom_field_1 = unit_custom_field_1;
        var unit_custom_field_2 = unit_custom_field_2;

        var BranchAutoId = $("#BranchAutoId").val();
        var one_line_narration = one_line_narration != null ? one_line_narration : "";
        var rate = 0;
        var price = 0;
        $.ajax({
            type: "POST",
    ...
    function calcutateFinal() {
        ...
        $.each($('.add_box_quantity'), function () {
            var box_quantity = $(this).val();
            box_quantity = Number(box_quantity);
            total_box += box_quantity;
        });
        ...
        $('#total_box').html(parseFloat(total_box).toFixed(2));
    }
