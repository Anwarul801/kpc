...

{
    ...
    $getDetail = $this->MyModel->getSearch($term);
   ...
   $data[] = $temp_array;
...

    {
        ...
        $data['getSizeList'] = $this->MyModel->getSizeList();

        $data['getColorList'] = $this->MyModel->getColorList();

        $data['getSubCatList'] = $this->MyModel->getSubCatList();

        $data['getModelList'] = $this->MyModel->getModelList();

        $data['departmentList'] = $this->MyModel->getDepartmentList();
       ...
       public function subCatEdit($editId){
        ...
        $data['getSingleSubCat'] = $this->MyModel->getSingleSubCat($editId);
...

    {
          ...
          $result = $this->MyModel->unpublishedSubCat($id);
...

    {
          ...
          $result = $this->MyModel->publishedSubCat($id);
    ...
    public function modelAdd(){
       ...
       public function modelEdit($editId){
        ...
        $data['getSingleModel'] = $this->MyModel->getSingleModel($editId);
...

    {
          ...
          $result = $this->MyModel->unpublishedModel($id);
...

    {
          ...
          $result = $this->MyModel->publishedModel($id);
     ...
     public function colorAdd(){
        ...
        $data['getSingleColor'] = $this->MyModel->getSingleColor($editId);
...

    {
          ...
          $result = $this->MyModel->unpublishedColor($id);
...

    {
          ...
          $result = $this->MyModel->publishedColor($id);
    ...
    public function sizeAdd(){
      ...
      public function sizeEdit($editId){
        ...
        $data['getSingleSize'] = $this->MyModel->getSingleSize($editId);
...

    {
          ...
          $result = $this->MyModel->unpublishedSize($id);
...

    {
          ...
          $result = $this->MyModel->publishedSize($id);
    ...
    public function departmentAdd(){
     ...
     public function departmentEdit($editId){
        ...
        $data['getDepartmentById'] = $this->MyModel->getSingleData($editId);
    ...
    public function departmentDelete($deleteId){
       ...
       $checkDeparemt= $this->MyModel->checkDepatmentId($deleteId);
...
//       exit();
...

    {
          ...
          $result = $this->MyModel->unpublishedDepartment($id);
...

    {
          ...
          $result = $this->MyModel->publishedDepartment($id);
...
//validation rules set here.
        ...
        $data['title'] = 'Pay Roll Voucher(Pay Slip)';
        ...
        $data['link_page_name'] = 'Payroll Voucher List';
...
//output to json format
        ...
        $data['designationList'] = $this->MyModel->getDesinationList();
    ...
    public function designationEdit($editId){
        ...
        $data['getdesignationById'] = $this->MyModel->getSingleDataDesignation($editId);
    ...
    public function designationDelete($deleteId){
        ...
        $checkDesignation= $this->MyModel->checkDesignationId($deleteId);
...

    {
          ...
          $result = $this->MyModel->unpublisheddesignation($id);
...

    {
          ...
          $result = $this->MyModel->publisheddesignation($id);
