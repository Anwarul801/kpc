...
class EmployeeSalaryConfigureController extends CI_Controller
{
    private $timestamp;
    private $admin_id;
    public $dist_id;
    ...
    public function employeeSalaryConfiquration()
    {
       ...
       if (isPostBack()) {
                ...
                if ($this->db->trans_status() === FALSE) {
                    ...
                    redirect(site_url($this->project . '/employeeSalaryConfiquration'));
                } else {
       ...
       // $data['dayBookCofig'] = $this->Accounts_model->getalldayBook();
        ...
        $data['title'] = 'Employee Salary Confiquration';
        $data['page_type'] = $this->page_type;
        $data['link_page_name'] = '';
        $data['link_page_url'] = '';
        $data['link_icon'] = "";
        /*page navbar details*/
        $data['pageTitle'] = 'Employee Salary Confiquration';
        $data['mainContent'] = $this->load->view('distributor/setup/employee/employeeSalaryConfigaration', $data, true);
