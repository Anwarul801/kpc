    ...
    function getProductList()
    {
        ...
        if ($cat_id != 'package') {
            ...
            if (!empty($productList)):
                $add .= "<option value=''></option>";
                foreach ($productList as $key => $value):
                    //$product_name=$value->SubCatName   $value->Model  $value->Color   $value->Size  $value->productName  [" . $value->brandName . "];
                    $product_name=$value->productName  ;
                    $add .= "<option unit_custom_field_1='".$value->unit_custom_field_1."' unit_custom_field_2='".$value->unit_custom_field_2."' ispackage='0' ispackage='0' brand_id='" . $value->brand_id . " 'brandName='" . $value->brandName . " ' property_1='" . $value->property_1 . " ' property_2='" . $value->property_2 . " ' property_3='" . $value->property_3 . " ' property_4='" . $value->property_4 . " ' salesPrice='" . $value->salesPrice . " ' property_5='" . $value->property_5 . " ' categoryName='" . $value->productCat . " '  categoryId='" . $value->category_id . "' productName='". $value->SubCatName . $value->productName . "' brandName='" . $value->brandName . "' value='" . $value->product_id . "' >$product_name</option>";
                endforeach;
                echo $add;
                DIE;
            else:
