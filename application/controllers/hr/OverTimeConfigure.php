...
class overTimeConfigure extends CI_Controller
{
    private $timestamp;
    private $admin_id;
    public $dist_id;
    ...
    public function overTimeConfiquration()
    {
       ...
       if (isPostBack()) {
        ...
        $data['title'] = 'Over Time Confiquration';
        $data['page_type'] = $this->page_type;
        $data['link_page_name'] = '';
        $data['link_page_url'] = '';
        $data['link_icon'] = "";
        /*page navbar details*/
        $data['pageTitle'] = 'Over Time Confiquration';
    ...
    public function overTimeConfigEdit($editId){
        ...
        /*page navbar details*/
        $data['title'] = get_phrase('Over Time Confiquration Edit');
        $data['page_type'] = $this->page_type;
