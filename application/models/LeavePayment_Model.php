...
class LeavePayment_Model extends CI_Model
{
    function __construct()
    {
       ...
       function getAllLeavePaymentDateList(){
        ...
        $this->db->where('salary_info.voucherType', '4');
    ...
    function leavePaymentDelete($voucher){
        $condition = array(
          'voucherNo' => $voucher
        );
